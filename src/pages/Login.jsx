  ...
  return (
    <div>
      <div className="flex flex-row  p-10 gap-40 max-w-7xl mx-auto justify-center items-center mt-10">
        <form className="flex flex-col gap-2 justify-center bg-slate-300 h-[350px] p-12 rounded-2xl">
          <h1 className="font-bold text-3xl p-3 ">Teacher Login</h1>
          <input
        ...
        <form className="flex flex-col gap-2 justify-center bg-slate-300 h-[350px] p-12 rounded-2xl">
          <h1 className="font-bold text-3xl p-3">Student Login</h1>
          <input
            className="bg-slate-200 text-sm  rounded-lg placeholder:text-black  p-3 font-semibold w-96"
            type="text"
            name="email"
